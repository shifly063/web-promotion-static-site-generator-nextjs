        ...
        <div>
            <section>
                <div className="skew skew-top mr-for-radius">
                    <svg className="h-8 lg:h-12 lg:h-20 w-full text-gray-50" viewBox="0 0 10 10"
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="relative flex flex-wrap -mx-4 z-0">
                            ...
                            <div className="mb-8 w-full lg:w-1/3 px-4 text-center">
                                <span
                                    className="relative mb-6 lg:mb-10 mx-auto flex w-16 h-16 items-center justify-center bg-green-600 rounded-full text-white text-2xl">
                                    1
                                </span>
                            ...
                            <div className="mb-8 w-full lg:w-1/3 px-4 text-center">
                                <span
                                    className="mb-4 lg:mb-10 mx-auto flex w-16 h-16 items-center justify-center bg-green-600 rounded-full text-white text-2xl">
                                    2
                                </span>
                                <h3 className="mb-4 text-2xl font-bold font-heading">
                                    Lorem ipsum dolor sit amet consectutar
