...
export default function Testimonial () {
    ...
    return (
        <div>
            <section>
                <div className="py-20 bg-black radius-for-skewed overflow-hidden">
                                        ...
                                        <div className="mb-4 w-full lg:w-1/3 px-3">
                                            <div className="p-8 bg-white rounded shadow text-center">
                                                <div className="bg-no-repeat bg-left-top"
                                                     style={{backgroundImage: 'url("https://i.pinimg.com/originals/e4/eb/67/e4eb6701eda27280a6c6bc1ef8ef30e9.jpg")'}}>
